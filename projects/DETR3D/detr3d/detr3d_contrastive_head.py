...
class DETR3DHead_Contrastive(DETRHead):
    """Head of DETR3D.
    ...
    def __init__(
        ...
        super(DETR3DHead_Contrastive, self).__init__(
    ...
    def forward(self, mlvl_feats: List[Tensor], img_metas: List[Dict],memory_text=None,text_token_mask=None,
        ...
        for lvl in range(hs.shape[0]):
            ...
            outputs_class = self.cls_branches[lvl](hs[lvl],memory_text,text_token_mask)
    ...
    def loss_by_feat_single(
        ...
        labels = torch.cat(labels_list, 0).unsqueeze(0)
        ...
        text_mask = text_mask.repeat(1, batch_cls_scores.size(1), 1)
        batch_cls_scores = torch.masked_select(batch_cls_scores, text_mask).contiguous()
    ...
    def loss_by_feat(
        ...
        self.text_masks = preds_dicts['text_token_mask']
